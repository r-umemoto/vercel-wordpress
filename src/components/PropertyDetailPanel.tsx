...
export default function PropertyDetailPanel({ property, isOpen, isLoading, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div
        className={`relative z-50 h-full w-full max-w-2xl bg-white dark:bg-gray-800 shadow-xl transition-transform duration-300 ease-in-out transform-gpu ml-auto ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        {renderContent()}
      </div>
